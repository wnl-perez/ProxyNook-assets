...
importScripts('/fernassets/vu/fern.bundle.js')
importScripts('/fernassets/vu/fern.config.js')
importScripts(__uv$config.sw || '/fernassets/vu/fern.sw.js')

importScripts("/fernassets/scramjet/scramjet.all.js")
